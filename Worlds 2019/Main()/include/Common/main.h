...
void encoderDrive(double ticks, double pct) {
    left1.startRotateFor(ticks, vex::rotationUnits::raw, pct, vex::velocityUnits::pct);
    right1.startRotateFor(ticks, vex::rotationUnits::raw, pct, vex::velocityUnits::pct);
    left2.startRotateFor(ticks, vex::rotationUnits::raw, pct, vex::velocityUnits::pct);
    right2.startRotateFor(ticks, vex::rotationUnits::raw, pct, vex::velocityUnits::pct);
    left3.startRotateFor(ticks, vex::rotationUnits::raw, pct, vex::velocityUnits::pct);
    right3.rotateFor(ticks, vex::rotationUnits::raw, pct, vex::velocityUnits::pct);
}
...
void gyroTurn(double target) {
    target = Gyro.value(vex::analogUnits::range12bit)+target*10+target*42/90;
